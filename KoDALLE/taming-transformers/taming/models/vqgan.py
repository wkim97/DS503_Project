...
class VQModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 0:
            ...
            self.log(
                "train/aeloss", aeloss, prog_bar=True, logger=True, on_step=True, on_epoch=True
            )
        ...
        if optimizer_idx == 1:
            ...
            self.log(
                "train/discloss", discloss, prog_bar=True, logger=True, on_step=True, on_epoch=True
            )
...
class VQNoDiscModel(VQModel):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        output.log(
            "val/rec_loss", rec_loss, prog_bar=True, logger=True, on_step=True, on_epoch=True
        )
